...
# `baton-freshbooks` [![Go Reference](https://pkg.go.dev/badge/github.com/conductorone/baton-freshbooks.svg)](https://pkg.go.dev/github.com/conductorone/baton-freshbooks) ![ci](https://github.com/conductorone/baton-freshbooks/actions/workflows/ci.yaml/badge.svg)
...
```
docker run --rm -v $(pwd):/out -e BATON_DOMAIN_URL=domain_url -e BATON_API_KEY=apiKey -e BATON_USERNAME=username public.ecr.aws/conductorone/baton-freshbooks:latest -f "/out/sync.c1z"
