...
func seed(s *State) {
	...
	members := []*teamMember{
		...
		{UUID: "tm-0003", FirstName: "Carol", LastName: "Employee", Email: "carol@example.com", BusinessRoleName: "business_employee", Active: true, InvitationDateAccepted: "2023-01-03"},
		...
		{UUID: "tm-0006", FirstName: "Frank", LastName: "Employee2", Email: "frank@example.com", BusinessRoleName: "business_employee", Active: false, InvitationDateAccepted: "2023-01-06"},
	...
	for i := 9; i <= 55; i++ {
		s.addMember(&teamMember{
			...
			BusinessRoleName: "business_employee",
			Active:           true,
		})
	}
}
